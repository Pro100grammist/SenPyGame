...
class Editor:
    def __init__(self):
        ...
        self.assets = {
            ...
            'portal_spawn': load_images('tiles/portals/portal_spawn/'),
            'npc_spawn': load_images('npc/npc_spawn'),
            'animated_tiles': load_images('tiles/animated_tiles')
        ...
        try:
            self.tilemap.load('edited_map.json')
